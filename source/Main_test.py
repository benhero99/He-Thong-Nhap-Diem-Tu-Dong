...
def main():
    for filename in os.listdir("data\Class_list_constrained"):
        ...
        start = time.time()
        # giaythi  = cv2.imread('data\Class_list_constrained\giaythi65.jpg', cv2.IMREAD_COLOR)
        ...
        cv2.imshow('name_crop',name_crop)
        # cv2.imwrite("doc/removeline_word_103/name_crop_giaythi.jpg",name_crop)
        ############### MSSV_RECOGNITION #######################
        ...
        cv2.imwrite("doc/removecircle/diem_crop4.jpg",diem_crop_copy)
        diem_recognized =str()
