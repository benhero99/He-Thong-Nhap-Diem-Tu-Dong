...
if not os.path.exists('model\digit_model/'+ str(datetime_object)):
    os.mkdir('model\digit_model/'+ str(datetime_object))

########## LOAD DATA ######################################################
data = pd.read_csv('data/aug_digit_data13.csv')
...
my_callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath='model/digit_model/'+str(datetime_object)+'/digit_model_{epoch:02d}_test.h5', 
                                       save_freq='epoch',
                                       monitor='val_loss',
                                       mode='min', 
                                       save_best_only=True,
...
plt.savefig('model/digit_model/'+str(datetime_object)+'/digit_model_loss_test.png')
plt.show()

with open('model/digit_model/'+str(datetime_object)+'/digit_model_test.txt', 'w', encoding='utf-8') as f:
...
with open('model/digit_model/'+str(datetime_object)+'/digit_model_test.txt', 'a', encoding='utf-8') as f:
