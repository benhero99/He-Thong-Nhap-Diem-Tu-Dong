...
class_list_dir = r'data\Class_list.xlsx'
# class_list_dir = r'data\test.xlsx'
...
#model\digit_model\digit_model_last_2022-07-05.h5
digit_model.load_weights(digit_model_dir)

    
start = time.time()
giaythi  = cv2.imread('data\Class_list_constrained\giaythi51.jpg', cv2.IMREAD_COLOR)
...
cv2.imshow('name_crop',name_crop)
# cv2.imwrite("doc/removeline_word_103/namecrop_giaythi1.jpg",name_crop)
############### MSSV_RECOGNITION #######################
...
# cv2.imwrite("doc/removeline_word_103/diem_crop.jpg",diem_crop_copy)
